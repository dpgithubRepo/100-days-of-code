...
public class TwoSum {
	...
	public static boolean twoSumPairExisits(int[] arr, int k) {
		Map<Integer, Integer> map = new HashMap<>();  // this method has extra space requirement for maintaining the map and can be further improved by 2 pointer technique
